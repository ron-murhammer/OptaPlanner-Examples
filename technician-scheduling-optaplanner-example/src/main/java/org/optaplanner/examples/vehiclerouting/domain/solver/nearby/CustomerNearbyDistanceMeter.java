...
public class CustomerNearbyDistanceMeter implements NearbyDistanceMeter<Task, Standstill> {

    @Override
    public double getNearbyDistance(Task origin, Standstill destination) {
